...
BASE_params = dict(time_max = 72.0, virus_delay = 0.0, NK_delay = 400.0, max_steps = 1000000, ani_step_save = 250,
                   grid_size = 100, max_NK = 3, a = 1.0, b = 3.0, max_inf_state = 30,
                   t_prog = 1.0, beta_spread = 1.0, t_spread = 50.0, M_I = 15,
                   gamma_ind = 1.0, t_ind = 300.0, gamma_dep = 0.01, t_dep = 30.0, 
                   MOI = 0.1, NK_ratio = 1.0, 
                   with_death_dep = True, with_death_ind = True, with_infection_spread = True, with_infection_progression = True)


#parameter to change:
PARAM_NAME = "gamma_dep"
PARAM_VALUES = [0]
