...
BASE_params = dict(time_max = 72.0, time_delay = 80.0, max_steps = 1000000, ani_step_save = 250,
                   grid_size = 100, max_NK = 3, a = 1.0, b = 3.0, max_inf_state = 10,
                   t_prog = 1.0, beta_spread = 1.0, t_spread = 50.0, M_I = 7,
...
for i, v in enumerate(PARAM_VALUES):
    ...
    out_path = f"results/without NK, {PARAM_NAME}={v}.npz"
