...
#active virus params
BASE_params = dict(time_max = 48.0, virus_delay = 0.0, NK_delay = 4.0, max_steps = 10_000_000, ani_step_save = 10_000,
                   grid_r = 100, grid_c = 100, max_NK = 3, a = 1.0, b = 3.0, max_inf_state = 30,
                   t_prog = 1, beta_spread = 1, t_spread = 119.6937, M_I_spread = 3, M_I_death = 25,
