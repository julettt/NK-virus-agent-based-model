...
#----- animation settings -----q
INPUT_FILE = "plot results/without NK, 0.npz"
SAVE_VIDEO = False
OUTPUT_VIDEO = "with NK, c_I=0.01, c_I_NK=0.03 nr. 2.mp4"
SHOW_NK = False
...
def play_animation():
    ...
    if SHOW_NK:
        ...
        fig, ax_epith = plt.subplots(figsize=(10, 4))
    ...
    if SAVE_VIDEO:
        ...
        ani.save(OUTPUT_VIDEO, writer='ffmpeg', fps=5, dpi=300, extra_args=['-preset', 'ultrafast'])
